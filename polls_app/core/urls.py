...
from polls_app.core.views import ProductsListCreateApiView, ProductRetrieveUpdateDeleteApiView, QuestionsApiView, QuestionCreateApiView, \
...
urlpatterns = (
    ...
    path("question/<int:question_pk>/", QuestionsApiView.as_view(), name="question"),
