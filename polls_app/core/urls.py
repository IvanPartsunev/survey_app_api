...
from polls_app.core.views import ProductsListApiView, ProductApiView, QuestionApiView, QuestionsListApiView
...
urlpatterns = (
    ...
    path("products/<int:product_pk>/questions/<int:question_pk>/", QuestionApiView.as_view(), name="product"),
)
